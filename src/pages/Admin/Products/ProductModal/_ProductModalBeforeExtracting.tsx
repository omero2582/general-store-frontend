...
export function ProductModal({formHookReturn, product, name} : ProductModalProps) {
  ...
  //
  // Categories state
  const [categoriesToAdd, setCategoriesToAdd]= useState(product?.categories.map(c => c.id) || []);
